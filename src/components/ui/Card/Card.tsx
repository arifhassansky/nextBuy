      ...
      <div className='rounded-2xl overflow-hidden relative group'>
         ...
         <div className='absolute inset-0 flex items-center justify-center md:pt-40 mb-10 w-[80%] md:w-full'>
            <button
               ...
               className='bg-[#2a61b4] text-white md:h-10 h-8 w-full rounded-b-lg shadow-lg opacity-0 translate-y-1 group-hover:opacity-100 group-hover:translate-y-0 transition-all duration-300 delay-200 cursor-pointer'
            >
               Add to Cart
            </button>
         </div>
