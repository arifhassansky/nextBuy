...
import { IoCartOutline, IoCloseOutline, IoMenuOutline, IoSettingsOutline } from 'react-icons/io5';
      ...
      fetch(`/api/cart?userEmail=${userEmail}`)
         ...
         .then(data => {
            data.data.items.forEach(item => {
               // console.log(`Product: ${item.productId.title}, Quantity: ${item.quantity}`);
         ...
         <div className='w-11/12 mx-auto px-4'>
            ...
            <div className='hidden lg:flex justify-between items-center py-2 border-b border-gray-200'>
               ...
               <div className='flex items-center space-x-3 text-sm '>
                  <Link className='flex items-center gap-1  font-medium' href='/newsletter'>
            ...
            <div className='flex items-center  mt-1 '>
               ...
               <div className='flex items-center space-x-6'>
                  <Link className='flex items-center gap-1 relative' href='/dashboard/wishlist'>
                     <CiHeart size={20} />
