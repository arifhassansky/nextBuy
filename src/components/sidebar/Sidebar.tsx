...
import { FaCartArrowDown, FaHistory, FaHome, FaUserEdit, FaUsersCog } from 'react-icons/fa';
         ...
         >
            {isCollapse ? (
               ...
               <Image
                  ...
                  width={80}
                  height={80}
                  className={`${isCollapse ? 'w-16' : 'w-12'} mx-auto cursor-pointer pt-8`}
         ...
         >
            {!user ? (
               ...
               <div className='flex items-center justify-center gap-2'>
                  ...
                  <h3 className={`${isCollapse ? 'inline' : 'hidden'}  text-gray-300 font-[500]`}>
                     {user?.name}
                  </h3>
                  <h3
                     className={`${
               ...
               <div className='mt-3 flex flex-col gap-[5px]'>
                ...
                ${
                  ...
                  >
                     <div className='flex items-center gap-2'>
                        <FaUserEdit className='text-[1.3rem]' />
                        <p className={`${isCollapse ? 'inline' : 'hidden'} text-[1rem]`}>Profile</p>
                     </div>
                ...
                ${
                  ...
                  {/* add stories */}
                  <Link
                     href='/dashboard/MyAddedProducts'
                     className={`
                ${
                   isCollapse ? 'justify-between' : 'justify-center'
                } flex items-center w-full p-[5px] rounded-md cursor-pointer transition-all duration-200 relative group ${
            ...
            <div className='mt-3 flex flex-col gap-[5px]'>
               ...
               >
                  <div className='flex items-center gap-2'>
                     ...
                     <p className={`${isCollapse ? 'inline' : 'hidden'} text-[1rem] `}>Home</p>
                  </div>
            ...
            <div className='mt-3 flex flex-col gap-[5px]'>
               ...
               >
                  <div className='flex items-center gap-2'>
                     ...
                     <p className={`${isCollapse ? 'inline' : 'hidden'} text-[1rem] `}>Logout</p>
                  </div>
