...
import { useGetCartQuery } from '@/redux/ProductApi';
...
export default function ProductDetailsPage() {
   ...
   const handleAddToCart = async (cart: Product) => {
      dispatch(addToCart({ cart, userEmails }));
      ...
      <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 mt-10'>
         ...
         <div>
            ...
            <p className='mt-4'>
               ...
               convallis bulum parturient suspendisse parturient a.Parturient in parturient
               scelerisque nibh lectus quam a natoque adipiscing a vestibulum hendrerit et pharetra
               fames nunc natoque dui.
            </p>
            ...
            <p className='mt-4'>
               ...
               lobortis tincidunt purus lectus nisl class eros.Condimentum a et ullamcorper dictumst
               mus et tristique elementum nam inceptos hac parturient scelerisque vestibulum amet
               elit ut volutpat.
            </p>
         </div>
      </div>
